    ...
    <div class="container">
      ...
      <div class="container">
        ...
        <c:if test="${oauthParams.idTokenValid}">
         ...
         <c:if test="${!empty oauthParams.idToken}">
          <div class="panel panel-idToken">
            <div class="panel-heading">
              <h3 class="panel-title">Raw_IDToken</h3>
            </div>
            <div class="panel-body"><pre><c:out value="${oauthParams.idToken}"/></pre></div>
          </div>
        </c:if>
        ...
        <c:if test="${!empty oauthParams.claimsSet}">
          <div class="panel panel-claimsSet">
            <div class="panel-heading">
